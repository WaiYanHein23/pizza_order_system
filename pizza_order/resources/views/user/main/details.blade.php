    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <a href="{{route('user#home')}}"><i class="fa-solid fa-circle-arrow-left"></i>  Back</a>
                <div id="product-carousel" class="mt-4 carousel slide" data-ride="carousel">
                ...
                <div class="owl-carousel related-carousel">
                   ...
                   <div class="product-item bg-light">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{asset('storage/'.$p->image)}}" alt="" style="height: 150px">
