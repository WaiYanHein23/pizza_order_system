    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="bg-light p-4 mb-30">
                <form>
                    <div class="d-flex align-items-center justify-content-between mb-3 bg-dark text-white p-3">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div>
                           <a href="{{route('user#cartList')}}"><button type="button" class="btn bg-dark text-white position-relative">
                    ...
                    <a href="{{route('user#history')}}"><button type="button" class="btn bg-dark text-white position-relative ms-3">
            ...
            <span class="row" id="dataList">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 pb-1 ">
                    <div class="product-item bg-light mb-4" id="myForm">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style="height: 150px" src="{{asset('storage/'.$p->image)}}" alt="">
                ...
                @else
                <h2 class="col-6 offset-3 shadow-sm">There is no pizza</h2>
                @endif
            </span>
    ...
    success : function(response){
       ...
       for($i=0;$i<response.length;$i++){
        $list +=`  <div class="col-lg-4 col-md-6 col-sm-6 pb-1 ">
                        <div class="product-item bg-light mb-4" id="myForm">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" style="height: 150px" src="{{asset('storage/${response[$i].image}')}}" alt="">
                                 <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
