                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown d-inline me-5">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="{{route('user#accountChangePage')}}"><i class="fa-solid fa-circle-user"></i> Account</a></li>
                                  <li><a class="dropdown-item" href="{{route('user#changePasswordPage')}}"><i class="fa-solid fa-key"></i> Change Password</a></li>
                                  <li><span class="dropdown-item">
                                    <form action="{{route('logout')}}" method="POST">
                                    @csrf
                                    <button class="btn bg-dark text-white" type="submit"><i class="fa-solid fa-right-from-bracket"></i>Logout</button>
                                </form></span></li>
                                </ul>
                              </div>
                        </div>
