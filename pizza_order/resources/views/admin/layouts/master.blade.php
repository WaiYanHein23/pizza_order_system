                    ...
                    <ul class="list-unstyled navbar__list">
                        <li>
                            <a href="{{route('category#list')}}">
                                <i class="fa-sharp fa-solid fa-list"></i>Category
                            </a>
                        </li>
                        <li>
                            <a href="{{route('product#list')}}">
                                <i class="fa-sharp fa-solid fa-list"></i>Products
                            </a>
                        </li>
                        <li>
                            <a href="{{route('admin#orderList')}}">
                                <i class="fa-sharp fa-solid fa-list"></i>Order
                            </a>
                        </li>
                        <li>
                            <a href="{{route('admin#userList')}}">
                                <i class="fa-sharp fa-solid fa-user"></i>User
                            </a>
                        </li>
                    </ul>
                </nav>
