                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('product#create')}}" enctype="multipart/form-data" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="pizzaWaitingTime" value="{{old('pizzaWaitingTime')}}" class="form-control @error('pizzaWaitingTime') is-invalid @enderror" placeholder="Waiting Time..">
